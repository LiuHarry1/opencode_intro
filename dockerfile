...
RUN mkdir -p /workspace/.opencode
RUN mkdir -p /workspace/.opencode/skills /workspace/.opencode/lsp /workspace/.opencode/plugins /workspace/.opencode/agent

COPY .opencode/skills/ /workspace/.opencode/skills/
COPY .opencode/lsp/ /workspace/.opencode/lsp/
COPY .opencode/plugins/ /workspace/.opencode/plugins/
COPY .opencode/agent/ /workspace/.opencode/agent/
